...
**用途**: Research Workflow 第一步 - 快速查阅节点概览和风险等级

**完整文档**: 请参阅 `reference/SCHEMA.md`

---

## Config File

- **Path**: `~/.openclaw/openclaw.json` (JSON5, 支持注释和尾随逗号)
- **Validation**: Zod schema (`OpenClawSchema`)，严格模式 — 未知键会导致 Gateway 拒绝启动
